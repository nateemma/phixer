...
class CameraManager {
    ...
    public static func setCamera(_ camera: Camera, location: PhysicalCameraLocation){
    ...
    public static func getCamera() -> Camera? {
        ...
        if (selectedCamera==nil){
            do {
                ...
                selectedCamera = try Camera(sessionPreset:AVCaptureSession.Preset.photo, location:cameraLocation)
    ...
    public static func setCameraLocation(_ location: PhysicalCameraLocation) {
    ...
    public static func switchCameraLocation() {
    ...
    public static func getCameraLocation() -> PhysicalCameraLocation {
        return cameraLocation
    }
    
    
    // returns the current screen resolution (differs by device type)
    public static func getCaptureResolution() -> CGSize {
    ...
    public static func getCurrentISO() -> String {
    ...
    public static func getCurrentSpeed() -> String {
