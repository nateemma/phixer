...
class EditBaseToolController: CoordinatedController, SubControllerDelegate {
    ...
    // override this if you need a different tool type than 'paneltool'
    func getToolType() -> ControllerType {
        return .paneltool
    }
   ...
   func getNextFilter() -> String {
    ...
    override func viewDidLoad() {
        ...
        self.view.frame = ControllerFactory.getFrame(self.getToolType())
