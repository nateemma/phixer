...
class ThemeChooserController: CoordinatedController {
    ...
    var selectedTheme:CustomTheme? = nil
    ...
    func doInit(){
        ...
        if (!initDone){
            ...
            selectedThemeKey = ThemeManager.getCurrentThemeKey()
        }
    }
    ...
    func layoutSampleView(){
        ...
        title.font = selectedTheme?.getFont(ofSize: 24.0, weight: UIFont.Weight.light)
        ...
        subtitle.font = selectedTheme?.getFont(ofSize: 20.0, weight: UIFont.Weight.ultraLight)
        ...
        buttonLabel.font = selectedTheme?.getFont(ofSize: 18.0, weight: UIFont.Weight.thin)
        ...
        button.titleLabel?.font = selectedTheme?.getFont(ofSize: 18, weight: UIFont.Weight.thin)
        ...
        switchLabel.font = selectedTheme?.getFont(ofSize: 18.0, weight: UIFont.Weight.thin)
        ...
        sliderLabel.font = selectedTheme?.getFont(ofSize: 18.0, weight: UIFont.Weight.thin)
...
extension ThemeChooserController: UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if pickerLabel == nil {
            pickerLabel = UILabel()
            pickerLabel?.font = selectedTheme?.getFont(ofSize: 16.0, weight: UIFont.Weight.thin)
