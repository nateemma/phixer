...
class FilterInfoView: UIView {
    ...
    func initViews(){
        ...
        if (!initDone){
            ...
            categoryLabel.titleLabel!.font = theme.getFont(ofSize: 14.0, weight: UIFont.Weight.thin)
            ...
            filterLabel.titleLabel!.font = theme.getFont(ofSize: 14.0, weight: UIFont.Weight.thin)
