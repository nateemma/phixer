...
class EditControlsView: UIView, iCarouselDelegate, iCarouselDataSource{
    ...
    private func createContainerView(icon:String, label:String) -> ImageContainerView{
        ...
        view.label.font = theme.getFont(ofSize: 8.0, weight: UIFont.Weight.thin)
    ...
    func layoutViews(){
        ...
        //controlLabel.font = theme.getFont(ofSize: 14.0)
        controlLabel.font = theme.getFont(ofSize: 12.0, weight: UIFont.Weight.thin)
