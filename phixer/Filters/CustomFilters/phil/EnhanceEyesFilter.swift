...
// filter that runs facial detection on an image and adjusts/enhances the eyes of any faces found
class EnhanceEyesFilter: CIFilter {
    
    let fname = "Enhance Eyes"
...
//                            kCIAttributeType: kCIAttributeTypeScalar],
    ...
    private func processImage() {
        ...
        for i in 0..<faceList.count {
            contourList.append(faceList[i].leftEye)
            contourList.append(faceList[i].rightEye)
        }
