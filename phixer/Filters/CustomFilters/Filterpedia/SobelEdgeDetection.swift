...
class SobelEdgeDetectionBase: CIFilter
{
    ...
    {
        return sourceImage.imageByApplyingFilter(filterName, withInputParameters: [kCIInputWeightsKey: horizontalWeights.multiply(inputWeight),
                                                                                   kCIInputBiasKey: inputBias])
                          .imageByApplyingFilter(filterName, withInputParameters: [kCIInputWeightsKey: verticalWeights.multiply(inputWeight),
                                                                                   kCIInputBiasKey: inputBias])
