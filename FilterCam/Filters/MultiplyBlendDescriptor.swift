...
class MultiplyBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "MultiplyBlend"
    let title = "Multiply Blend"
    ...
    fileprivate var lclFilter:MultiplyBlend = MultiplyBlend() // the actual filter
