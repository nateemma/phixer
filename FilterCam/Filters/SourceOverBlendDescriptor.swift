//
//  SourceOverBlendDescriptor.swift
//  FilterCam
//
...
class SourceOverBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "SourceOverBlend"
    let title = "SourceOver Blend"
    ...
    fileprivate var lclFilter:SourceOverBlend = SourceOverBlend() // the actual filter
