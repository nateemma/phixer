//
//  KuwaharaRadius3Descriptor.swift
//  FilterCam
//
...
class KuwaharaRadius3Descriptor: FilterDescriptorInterface {
    
    
    let key = "KuwaharaRadius3"
    let title = "Kuwahara (Radius 3)"
    ...
    func reset(){
        ...
        lclFilter = KuwaharaRadius3Filter()
        restoreParameters()
    }
