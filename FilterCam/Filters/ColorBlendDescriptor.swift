...
class ColorBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "ColorBlend"
    let title = "Color Blend"
    ...
    fileprivate var lclFilter:ColorBlend = ColorBlend() // the actual filter
