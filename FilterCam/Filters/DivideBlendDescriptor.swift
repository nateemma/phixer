...
class DivideBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "DivideBlend"
    let title = "Divide Blend"
    ...
    fileprivate var lclFilter:DivideBlend = DivideBlend() // the actual filter
