...
class DarkenBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "DarkenBlend"
    let title = "Darken Blend"
    ...
    fileprivate var lclFilter:DarkenBlend = DarkenBlend() // the actual filter
