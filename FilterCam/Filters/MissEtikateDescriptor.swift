...
class MissEtikateDescriptor: FilterDescriptorInterface {
    
    
    let key = "MissEtikate"
    let title = "MissEtikate"
    ...
    fileprivate var lclFilter:MissEtikateFilter = MissEtikateFilter() // the actual filter
