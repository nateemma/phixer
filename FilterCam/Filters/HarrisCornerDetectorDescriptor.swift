//
//  HarrisCornerDetectorDescriptor.swift
//  FilterCam
//
...
class HarrisCornerDetectorDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:HarrisCornerDetector = HarrisCornerDetector() // the actual filter
    ...
    func reset(){
        ...
        lclFilter = HarrisCornerDetector()
        restoreParameters()
    }
