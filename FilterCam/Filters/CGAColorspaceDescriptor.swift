...
class CGAColorspaceDescriptor: FilterDescriptorInterface {
    
    
    let key = "CGAColorspace"
    let title = "CGAColorspace"
    ...
    private var lclFilter:CGAColorspaceFilter = CGAColorspaceFilter() // the actual filter
