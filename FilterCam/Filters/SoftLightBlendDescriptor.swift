//
//  SoftLightBlendDescriptor.swift
//  FilterCam
//
...
class SoftLightBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "SoftLightBlend"
    let title = "SoftLight Blend"
    ...
    fileprivate var lclFilter:SoftLightBlend = SoftLightBlend() // the actual filter
