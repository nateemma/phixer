//
//  SaturationBlendDescriptor.swift
//  FilterCam
//
...
class SaturationBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "SaturationBlend"
    let title = "Saturation Blend"
    ...
    fileprivate var lclFilter:SaturationBlend = SaturationBlend() // the actual filter
