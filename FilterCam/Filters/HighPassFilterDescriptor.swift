//
//  HighPassFilterDescriptor.swift
//  FilterCam
//
...
class HighPassFilterDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:HighPassFilter = HighPassFilter() // the actual filter
