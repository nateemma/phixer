//
//  ExclusionBlendDescriptor.swift
//  FilterCam
//
...
class ExclusionBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "ExclusionBlend"
    let title = "Exclusion Blend"
