//
//  SingleComponentGaussianBlurDescriptor.swift
//  FilterCam
//
...
class SingleComponentGaussianBlurDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:SingleComponentGaussianBlur = SingleComponentGaussianBlur() // the actual filter
    ...
    func reset(){
        ...
        lclFilter = SingleComponentGaussianBlur()
        restoreParameters()
    }
