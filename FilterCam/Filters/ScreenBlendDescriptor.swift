...
class ScreenBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "ScreenBlend"
    let title = "Screen Blend"
    ...
    fileprivate var lclFilter:ScreenBlend = ScreenBlend() // the actual filter
