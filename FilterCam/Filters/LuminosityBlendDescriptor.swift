//
//  LuminosityBlendDescriptor.swift
//  FilterCam
//
...
class LuminosityBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "LuminosityBlend"
    let title = "Luminosity Blend"
    ...
    fileprivate var lclFilter:LuminosityBlend = LuminosityBlend() // the actual filter
