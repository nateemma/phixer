//
//  ColorInversionDescriptor.swift
//  FilterCam
//
...
class ColorInversionDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:ColorInversion = ColorInversion() // the actual filter
