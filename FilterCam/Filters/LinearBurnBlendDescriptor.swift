//
//  LinearBurnBlendDescriptor.swift
//  FilterCam
//
...
class LinearBurnBlendDescriptor: FilterDescriptorInterface {
    
    
    let key = "LinearBurnBlend"
    let title = "LinearBurn Blend"
