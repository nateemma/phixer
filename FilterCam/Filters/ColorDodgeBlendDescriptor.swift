//
//  ColorDodgeBlendDescriptor.swift
//  FilterCam
//
...
class ColorDodgeBlendDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:ColorDodgeBlend = ColorDodgeBlend() // the actual filter
