//
//  HardLightBlendDescriptor.swift
//  FilterCam
//
...
class HardLightBlendDescriptor: FilterDescriptorInterface {
    ...
    fileprivate var lclFilter:HardLightBlend = HardLightBlend() // the actual filter
