...
# Many preset XMP files include settings with zero values, so we generally check for that and don't apply the corresponding filter if no changes are made
